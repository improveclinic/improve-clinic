...
export class Prenota implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setSeoData({
      ...
      description:
        'Prenota online una consulenza con i nostri fisioterapisti. Richiedi un appuntamento senza impegno a Rovereto.',
      keywords:
        'prenotazione, consulenza, appuntamento, fisioterapia, online',
  ...
  ngAfterViewInit(): void {
    ...
    if (calendly && calendlyEmbed) {
      calendly.initInlineWidget({
        url: 'https://calendly.com/amm-improveclinic/new-appointment?hide_event_type_details=1&hide_gdpr_banner=1&primary_color=e01d85',
